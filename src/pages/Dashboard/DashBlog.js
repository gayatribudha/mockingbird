        ...
        <div className="dashboard">
            <div className="row px-3 px-md-5 pt-lg-5 flex flex-row">
                <div className="col-3 pt-5 pt-md-5 pt-lg-0">
                    ...
                    <h1 className="title create-blog-title mt-5 mt-md-0 mt-lg04">Blogs</h1>
                </div>
            ...
            [1,2,3 ].map(n => (
                <div className="col-sm-12 col-md-5 col-lg-5 ml-md-4 ml-lg-4  mt-3 d-blog-card">
                     <Link activeClassName="sidebar-menu_active" to="/dashboard/show-blog" style={{textDecoration: "none"}}>
                    <div className="pt-3">
                ...
                {/* <div className="col-sm-12 col-md-5 col-lg-5 d-blog-card ">


                    <div className="pt-3">
                        <h3>Inside the city of glass and steel.</h3>
                        <p>Velit porro qui quo autem aut porro recusandae a. Quam molestias deserunt qu.</p>
                    </div>
                </div>
                <div></div>
                <div className=" col-sm-12 col-md-5 col-lg-5 mt-2 mt-md-0 mt-lg-0 offset-md-1 offset-lg-1    d-blog-card">
                    <div className="pt-3">
                        <h3>Hotel diaries of high school.</h3>
                        <p>Velit porro qui quo autem aut porro recusandae a. Quam molestias deserunt qu.</p>
                    </div>
                </div> */}
            </div>
