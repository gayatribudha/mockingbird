...
export default function Home() {
    return (
        <div className="container-fluid">
            <div className="row my-3 pb-5 mx-2 mx-md-5 mx-lg-5 px-md-4 px-lg-4">
                ...
                <div className="right-box col-sm-12 col-md-6 col-lg-6 px-sm-3 px-md-5 py-md-5 py-lg-5 ">
                    <div className="px-3 py-3 px-md-5 px-lg-5 py-md-0 py-lg-0">
                        ...
                        <p className="bottom-text mt-4">Don't know each other yet? <span className="signup">Sign Up</span></p>
                    </div>
                </div>
            </div>
            <Footer />
